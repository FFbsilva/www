...
;( function( $, window, undefined ) {
	...
	$.Slitslider.prototype = {
		...
		_init : function( options ) {
			...
			slides = this.$el.children( '.sl-slide' ).hide();
			this.$slides2 = $( '.slider-more' ).children( '.sl-slide').hide();
			//delete this.$slides.selector;
			this.$slides2.each(function( index, element ) {
				this.slidesCount++;
				slides.push(element);
			});
			// the slides
			...
			//console.debug(this.slidesCount);
		...
		_navigate : function( dir, pos ) {
			...
			if( this.isAnimating || this.slidesCount < 3 ) {
